...
import { EyeOutlined, DownloadOutlined, PlaySquareOutlined, ReloadOutlined, PoweroffOutlined, FundProjectionScreenOutlined } from '@ant-design/icons';
                ...
                <div>
                    ...
                    >
                        <Descriptions title="基本信息" bordered column={{ xxl: 2, xl: 2, lg: 2, md: 2, sm: 2, xs: 1 }}>
                            ...
                            <Descriptions.Item label="IP">{`${data.NetworkSettings.Networks[`${network_drive}`].IPAddress}(${network_drive})`}</Descriptions.Item>
                            ...
                            <Descriptions.Item span={2} label="操作">
                                <Tooltip placement="top" title="启动容器">
                                    <Button type="primary" shape="circle" icon={<PlaySquareOutlined />} size="small" />
                                </Tooltip>
                                <Tooltip placement="top" title="重启容器">
                                    <Button style={{ marginLeft: 8 }} type="primary" shape="circle" icon={<ReloadOutlined />} size="small" />
                                </Tooltip>
                                <Tooltip placement="top" title="结束容器">
                                    <Button style={{ marginLeft: 8 }} type="primary" shape="circle" icon={<PoweroffOutlined />} size="small" danger />
                                </Tooltip>
                                <Tooltip placement="top" title="启动终端">
                                    <Button style={{ marginLeft: 8 }} type="primary" shape="circle" icon={<FundProjectionScreenOutlined />} size="small" />
                                </Tooltip>
                            </Descriptions.Item>
                        </Descriptions>
                        <br /><br />
